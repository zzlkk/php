...
<script type="text/javascript"> 
		...
		$(document).ready(function() {
			...
			$('#inputDiv').show();
			$('#activelistDiv').show();
			$('#mngprofile').click(function(){
				$('#btnpss').hide();
				$('#apartlistDiv').hide();
				$('#gallery').hide();
				$('#inputDiv').hide();
				$('#activelistDiv').hide();
				var querystr='actioncode=3&form='+1;
...
<tr>
  <td height="600px" width="20%" valign="top"><div class="glossymenu"> <a class="menuitem submenuheader" href="#">我的资料</a>
      <div class="submenu">
        <ul>
      ...
      <a class="menuitem submenuheader" href="#" >我的列表</a>
      <div class="submenu">
        <ul>
          <li><a href="my-apartList.php" id="mnglisting">房间列表</a></li>
          <li><a href="my-apartGallery.php" id="mnggallery">房间图库</a></li>
          <li><a href="my-apartpriceList.php" id="mnglisting">管理价格计划</a></li>
        </ul>
      </div>
      ...
      <div class="submenu">
        <ul>
          ...
          <li><a href="my-apartmentblockList.php" id="mngcuslist">房间预订列表</a></li>
        </ul>
      </div>
      <a class="menuitem" href="logout.php">退出</a>
    </div></td>
