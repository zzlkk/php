...
if(mysql_num_rows($get_sub_title)){
	...
	$main_title=ucwords(strtolower($get_parent_title_row['name'])).' > '.$get_sub_title_row['name'];
...
<div id="top">
  <div id="top-inside">
    <div id="bsi-addmin-text">管理面板</div>
    <div class=" top-link_last"><a href="logout.php">退出</a></div>
    <div class=" top-link"><a href="change_password.php">修改密码</a></div>
    <div class=" top-link"><a href="admin-home.php">首页</a></div>
  </div>
</div>
<div id="con">
<div id="container">
