...
define('EASYPOPULATE_MSGSTACK_LANGER','');
define('EASYPOPULATE_MSGSTACK_INSTALL_CHMOD_FAIL','<b>在修复上传目录问题后，请重新运行批量商品管理安装。</b>');
define('EASYPOPULATE_MSGSTACK_INSTALL_CHMOD_SUCCESS','<b>安装成功!</b>商店的全部商品输出成功，位于上传目录(tempEP)，可以用于上传/更新商品的模板。');
...
define('EASYPOPULATE_MSGSTACK_FILE_EXPORT_SUCCESS', '文件 <b>%s</b> 成功导出! 该文件可以从 /%s 目录中下载。');
