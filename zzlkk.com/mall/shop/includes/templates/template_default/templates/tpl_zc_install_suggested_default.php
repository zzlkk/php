...
<meta name="generator" content="shopping cart program by Zen Cart&reg;, http://www.zen-cart.cn" />
...
<h2>看到本页面有几个原因:</h2>
<ol>
<li>您是<strong>第一次使用 Zen Cart&reg; 中文版</strong> 且还未正常安装。<br />
如果是这样的话，
<?php if ($instPath) { ?>
...
可访问 Zen Cart&reg; <a href="http://www.zen-cart.cn/forum/" target="_blank">中文论坛</a>获取更多信息。</li>
<?php if (isset($problemString) && $problemString != '') { ?>
<li class="errorDetails">其他*重要*说明: <?php echo $problemString; ?></li>
<?php } ?>
</ol>
<br />
<h2>开始安装 ...</h2>
...
<?php } else { ?>
<li>安装文档在 Zen Cart&reg; 安装包中的 /docs 目录下。</li>
<?php } ?>
<?php if ($instPath) { ?>
...
<?php } ?>
<li>Zen Cart&reg; <a href="http://www.zen-cart.cn/forum/" target="_blank">中文论坛的新手上路栏目</a>有基本的入门资料。</li>
</ol>

</div>
    <p style="text-align: center; font-size: small;">版权所有 &copy; 2003-<?php echo date('Y'); ?> <a href="http://www.zen-cart.cn" target="_blank">Zen Cart&reg; 中文版</a></p>
</body></html>
