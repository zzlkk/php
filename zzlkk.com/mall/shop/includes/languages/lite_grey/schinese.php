...
// whats_new box text in sideboxes/whats_new.php
  define('BOX_HEADING_WHATS_NEW', '新品商家');
  define('CATEGORIES_BOX_HEADING_WHATS_NEW', '新品上架 ...');
...
// specials box text in sideboxes/specials.php
  define('BOX_HEADING_SPECIALS', '优惠促销');
  define('CATEGORIES_BOX_HEADING_SPECIALS','优惠促销 ...');
...
// javascript messages
  ...
  define('ENTRY_LAST_NAME', '姓名：');
  define('ENTRY_LAST_NAME_ERROR', '姓名输入正确吗？本系统要求姓氏不能少于' . ENTRY_LAST_NAME_MIN_LENGTH . '个字符。');
  ...
  define('ENTRY_EMAIL_ADDRESS', '账户名：');
  define('ENTRY_EMAIL_ADDRESS_ERROR', '账户名不能少于' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . '个字符。');
...
// constants for use in zen_prev_next_display function
  ...
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW', '显示<strong>%d</strong>至<strong>%d</strong> (共<strong>%d</strong>件新品上架)');
  define('TEXT_DISPLAY_NUMBER_OF_SPECIALS', '显示<strong>%d</strong>至<strong>%d</strong> (共<strong>%d</strong>件优惠促销)');
