...
define('ZEN_LIGHTBOX_ALT_PREVIOUS', '上一张');
define('ZEN_LIGHTBOX_ALT_NEXT', '下一张');
define('ZEN_LIGHTBOX_ALT_CLOSE', '关闭');

define('ZEN_LIGHTBOX_COUNTER_IMAGE', '第');
define('ZEN_LIGHTBOX_COUNTER_OF', '张，总共');
?>