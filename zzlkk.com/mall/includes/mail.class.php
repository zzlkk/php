...
class bsiMail 
{
	...
	function bsiMail() {
		...
		if($this->isSMTP == true){	
			...
			$this->emailFrom = $bsiCore->config['conf_apartment_name']."<2196848320@qq.com>";		
		}else{
		...
		$this->smtpPort 		= intval(25);
		$this->smtpUserName 	= "2196848320@qq.com";
		$this->smtpPassword 	= "peidi666";	
		if(!$this->smtpPort){
			$this->smtpPort = NULL;
		}			
	}
