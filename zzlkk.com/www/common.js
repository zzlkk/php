function ascroll(pid,line,speed){
	$("#"+pid+" > :first-child").animate({marginTop:0-$("#"+pid+" > :first-child").height()*line},speed,function(){
		for(var i=1;i<=line;i++){
			$("#"+pid+" > :first-child").appendTo($("#"+pid)).css({marginTop:0});
		}
	});
}
function cutscroll(pid){
	$("#"+pid+" > :first-child").slideUp(function(){
		$(this).appendTo($("#"+pid)).show();
	});
}
/**
 * 遮罩弹出层
