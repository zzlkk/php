...
CREATE TABLE IF NOT EXISTS `auth_group` (
  ...
  `sort` smallint(2) NOT NULL DEFAULT '99',
  PRIMARY KEY (`id`)
...
INSERT INTO `auth_group` (`id`, `title`, `status`, `rules`, `pid`, `sort`) VALUES
(1, '超级管理员', 1, '1', 0, 99),
(2, '管理员', 1, '', 0, 99),
(3, '网站编辑', 1, '', 0, 99);
...
INSERT INTO `auth_rule` (`id`, `name`, `title`, `status`, `condition`, `pid`, `sort`) VALUES
(1, 'Index_index', '首页初始化', 1, '', 0, 99),
(4, 'Role_index', '权限管理', 1, '', 0, 99),
(3, 'Role_disable', '禁用权限', 1, '', 4, 99),
(6, 'Role_enable', '启用权限', 1, '', 4, 98),
(7, 'Index_user', '用户中心', 1, '', 1, 99),
(8, 'Index_cpwd', '修改密码', 1, '', 7, 99),
(9, 'Index_shop', '店铺信息', 1, '', 1, 99),
(14, 'Index_locked', '锁定密码', 1, '', 8, 99);
...
INSERT INTO `userinfo` (`id`, `name`, `pwd`, `nick`, `state`, `time`) VALUES
(1, 'kk', 'dc468c70fb574ebd07287b38d0d0676d', 'kkl', 1, '2013-09-08 09:45:20');
...
INSERT INTO `users` (`id`, `email`, `phone`, `u_qq`, `nick`, `regTime`, `pwd`, `head`, `name`, `status`) VALUES
(10000, 'kk@zzlkk.com', '185', '7577A428E2143E9D3172BC40F8544B4E', 'kk', '2013-10-03 16:34:46', 'dc468c70fb574ebd07287b38d0d0676d', 'http://q.qlogo.cn/qqapp/100271837/7577A428E2143E9D3172BC40F8544B4E/100', 'kk', 1),
(10001, '', '', 'D053972C09390A41DCAD82A656231CEB', '千山雪', '2013-10-06 00:56:55', '', 'http://q.qlogo.cn/qqapp/100271837/D053972C09390A41DCAD82A656231CEB/100', '', 1),
(10002, '', '', '8A2918B69AC516E658CE8B2FD06AE37E', '□ ｋｋ □ ', '2013-10-06 06:09:02', '', 'http://q.qlogo.cn/qqapp/100271837/8A2918B69AC516E658CE8B2FD06AE37E/100', '', 1),
(10003, '', '', '95D6E3D2D9B87F4851544EDFC9BA9E11', '地獄幽靈', '2013-10-06 10:16:32', '', 'http://q.qlogo.cn/qqapp/100271837/95D6E3D2D9B87F4851544EDFC9BA9E11/100', '', 1),
(10004, '', '', 'B93A15E6BFAF7B1226039272DEEDED31', '雪中送炭', '2013-10-10 06:11:43', '', 'http://q.qlogo.cn/qqapp/100271837/B93A15E6BFAF7B1226039272DEEDED31/100', '', 1);
...
--
-- 转存表中的数据 `weibo_config`
--

INSERT INTO `weibo_config` (`id`, `key`, `value`) VALUES
(1, 'current', '1065551117'),
(2, 'thread', '8');
